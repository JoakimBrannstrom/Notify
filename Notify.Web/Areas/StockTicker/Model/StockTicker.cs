...
namespace Notify.Web.Areas.StockTicker.Model
{
	/// <summary>
	/// Pumping fake stocks...
	...
	public class StockTicker
	{
		...
		public StockTicker(Action<Stock> onTick, int updateInterval = 250)
		{
			...
			stockTimer.Elapsed += StockTimerElapsed;
			stockTimer.Start();
		}

		private void StockTimerElapsed(object sender, ElapsedEventArgs e)
		{
		...
		private static void LoadDefaultStocks()
		{
			...
			stocks
			.ForEach(stock => Stocks.TryAdd(stock.Symbol, stock));
		}
